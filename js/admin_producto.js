$(document).ready(function(){
	$(".marca_animal_edad").click(function(){
		var marca=$("#marca").val();
		...
		if(marca=="marca"){
			...
			alert("Selecciona "+animal);
		}
		else if(edad=="edad"){
			alert("Selecciona "+edad);
		}
		else{
			$.get("productos.php", {"parametro": "marca_animal_edad", "marca": marca, "animal": animal, "edad": edad},function (datos) {
		        $(".admin").html(datos);
		    });
		}
