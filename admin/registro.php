...
<div class="centro">
	<form action="#">
	   	<fieldset>
	   		<legend>Insertar administrador</legend>
	    	...
	    	<div class="centro_user">
				...
				<div class="separador_corto"></div> 
				<div class="row">
					<div class="col-xd-12 col-sm-6 col-md-4 insertar">          
					    <input type="button" class="btn btn-primary" value="Insertar administrador">
					</div>
				</div>
			</div>
		</fieldset>
